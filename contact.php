...
<!-- Mirrored from www.nicdarkthemes.com/themes/baby-kids/html/demo/contact-1.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 11:43:02 GMT -->
<head>
 
    <meta charset="utf-8">  
    
    <title>Contact Us</title> <!--insert your title here-->  
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_4">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                <div class="nicdark_margin20 nicdark_relative">
                        <a href="#" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_orange extrabig nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i class="icon-phone-outline nicdark_rotate"></i></a>
                        <div class="nicdark_activity nicdark_marginleft100 nicdark_disable_marginleft_ipadpotr">
                            <h4>Call Us</h4>                        
                            <div class="nicdark_space20"></div>
...
<div class="nicdark_container">
        ...
        <div class="nicdark_archive1 nicdark_bg_greydark nicdark_radius nicdark_shadow">
            <div class="nicdark_margin20 nicdark_relative">
                ...
                <div class="nicdark_activity nicdark_marginleft100 nicdark_disable_marginleft_ipadpotr">
                    ...
                    <div class="nicdark_space20"></div>
                    <p class="white"> 810, 8th Floor,<br>
                            Vijaya Building, Barakhamba<br>
                            New Delhi - 110001</p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid_6">
        <div class="nicdark_archive1 nicdark_bg_greydark nicdark_radius nicdark_shadow">
            <div class="nicdark_margin20 nicdark_relative">
                    <a href="#" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_green extrabig nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i class="icon-location-outline nicdark_rotate"></i></a>
                    <div class="nicdark_activity nicdark_marginleft100 nicdark_disable_marginleft_ipadpotr">
                        <h4 class="white">Head Office</h4>                        
                        <div class="nicdark_space20"></div>
                        <p class="white">B3/39, Janakpuri,<br>
