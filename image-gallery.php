    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                ...
                <div class="nicdark_space100"></div>
                <h1 class="white subtitle">IMAGE GALLERY</h1>
...
<div class="nicdark_section">
 <div class="nicdark_container">
    <div class="row">
    <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align: center">
        <h1 class="subtitle greydark">GALLERY</h1>
            <div class="nicdark_divider small"><span class="nicdark_bg_yellow nicdark_radius"></span></div>
    </div>
