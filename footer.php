    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <div class="nicdark_margin10">
                ...
                <div class="nicdark_divider left small"><span class="nicdark_bg_white nicdark_radius"></span></div>
                <div class="nicdark_space20"></div>
                <a href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d387144.007583421!2d-73.97800349999999!3d40.7056308!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew+York%2C+Stati+Uniti!5e0!3m2!1sit!2sit!4v1414358887828" class="nicdark_zoom nicdark_mpopup_iframe nicdark_btn nicdark_bg_yellow medium nicdark_shadow nicdark_radius white"><i class="icon-location-outline"></i>&nbsp;&nbsp;&nbsp;View On Map</a>&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
        </div>
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <ul class="sub-menu footer-menu">
                ...
                <li class="nicdark_shadow nicdark_radius"><a href="conatct.php">CONTACT US</a></li>
            </ul>
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <div class="nicdark_margin10">
                ...
                <a href="submit-message.html" class="nicdark_mpopup_ajax nicdark_btn nicdark_bg_green small nicdark_shadow nicdark_radius white nicdark_press"><i class="icon-paper-plane-empty"></i>&nbsp;&nbsp;&nbsp;SEND</a>
            </div>
        </div> 
