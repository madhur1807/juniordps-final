...
<!-- Mirrored from www.nicdarkthemes.com/themes/baby-kids/html/demo/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 11:41:54 GMT -->
<head>
 
    <meta charset="utf-8">  
    
    <title>Junior DPS | Home</title> <!--insert your title here-->  
		...
		<div class="nicdark_slide1" >
			...
			<ul>
				...
				<li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"  data-title="FRIENDS">
					<img src="img/new/main-1.jpg"  alt="" data-lazyload="img/car4.jpg" data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat">
				</li>
				<!--end first-->
				...
				<li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on"  data-title="LESSON">
					<img src="img/new/main-2.jpg"  alt="" data-lazyload="img/car2.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
				</li>
				<!--end second-->

                <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" data-saveperformance="on"  data-title="LESSON">
                    <img src="img/new/main-3.jpg"  alt="" data-lazyload="img/car3.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                </li>
			</ul>
		...
		<div class="grid grid_12 percentage nomargin">    
			<div class="nicdark_textevidence center">
			    ...
			    <div class="nicdark_textevidence nicdark_width_percentage25 nicdark_bg_yellow nicdark_shadow">
			        <div class="nicdark_textevidence">
			            <div class="nicdark_margin30">
			                <h2 class="white subtitle"><a class="white" href="admissions.php">ADMISSION</a></h2>
			           </div>
			    ...
			    <div class="nicdark_textevidence nicdark_width_percentage25 nicdark_bg_orange nicdark_shadow">
			        <div class="nicdark_textevidence">
			            <div class="nicdark_margin30">
			                <h2 class="white subtitle"><a class="white" href="all-events.php">EVENTS</a></h2>
			           </div>
			    ...
			    <div class="nicdark_textevidence nicdark_width_percentage25 nicdark_bg_green nicdark_shadow nicdark_radius_right">
			        <div class="nicdark_textevidence">
			            <div class="nicdark_margin30">
			                <h2 class="white subtitle"><a class="white" href="all-teachers.php">TEACHERS</a></h2>
			           </div>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_4 nicdark_relative">
            ...
            <div class="nicdark_activity nicdark_marginleft100">
                ...
                <div class="nicdark_space20"></div>
                <a href="javascript:void(0)" class="nicdark_btn grey"><i class="icon-right-open-outline"></i> More</a>
                <div class="nicdark_space20"></div>
            </div>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_yellow nicdark_radius nicdark_shadow">
                ...
                <img alt=""  src="img/new/spring-1.jpg" style="height: 40vh">
	...
	jQuery(document).ready(function() {
        $('.collapse-button').click(function(){
            $(this).text(function(i, text){
                return text === "Show All Branches" ? "Hide Cities" : "Show All Branches";
            })
        })
