...
<!-- Mirrored from www.nicdarkthemes.com/themes/baby-kids/html/demo/events.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 11:41:47 GMT -->
<head>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <!-- <div class="grid grid_12 nicdark_bg_grey nicdark_shadow nicdark_radius nicdark_relative">
            ...
            <a href="#" class="nicdark_displaynone_iphoneland nicdark_displaynone_iphonepotr nicdark_btn_icon nicdark_bg_green  extrabig nicdark_radius_left white nicdark_absolute"><i class="icon-search-2"></i></a>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_green nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_margin20">
                    <h5 class="white"><i class="icon-pin-outline"></i>Location</h5>
                    <div class="nicdark_space10"></div>
                    ...
                    <div class="nicdark_space20"></div>
                    <a href="event.php" class="nicdark_press nicdark_btn nicdark_bg_greendark white nicdark_radius nicdark_shadow medium">CHECK IT</a>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_blue nicdark_radius nicdark_shadow">
                ...
                <a href="#" class="nicdark_btn nicdark_bg_greydark white medium nicdark_radius nicdark_absolute_left">10<br/><small>MAY</small></a>
                ...
                <div class="nicdark_margin20">
                    ...
                    <p class="white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque tincidunt rutrum.</p>
                    <div class="nicdark_space20"></div>
                    <a href="event.php" class="nicdark_press nicdark_btn nicdark_bg_bluedark white nicdark_radius nicdark_shadow medium">CHECK IT</a>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_yellow nicdark_radius nicdark_shadow">
                ...
                <a href="#" class="nicdark_btn nicdark_bg_greydark white medium nicdark_radius nicdark_absolute_left">24<br/><small>MAR</small></a>
                ...
                <div class="nicdark_margin20">
                    ...
                    <p class="white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque tincidunt rutrum.</p>
                    <div class="nicdark_space20"></div>
                    <a href="event.php" class="nicdark_press nicdark_btn nicdark_bg_yellowdark white nicdark_radius nicdark_shadow medium">CHECK IT</a>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_orange nicdark_radius nicdark_shadow">
                ...
                <a href="#" class="nicdark_btn nicdark_bg_greydark white medium nicdark_radius nicdark_absolute_left">30<br/><small>DEC</small></a>
                ...
                <div class="nicdark_margin20">
                    ...
                    <p class="white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque tincidunt rutrum.</p>
                    <div class="nicdark_space20"></div>
                    <a href="event.php" class="nicdark_press nicdark_btn nicdark_bg_orangedark white nicdark_radius nicdark_shadow medium">CHECK IT</a>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_violet nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_margin20">
                    ...
                    <p class="white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque tincidunt rutrum.</p>
                    <div class="nicdark_space20"></div>
                    <a href="event.php" class="nicdark_press nicdark_btn nicdark_bg_violetdark white nicdark_radius nicdark_shadow medium">CHECK IT</a>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_red nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_margin20">
                    ...
                    <p class="white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque tincidunt rutrum.</p>
                    <div class="nicdark_space20"></div>
                    <a href="event.php" class="nicdark_press nicdark_btn nicdark_bg_reddark white nicdark_radius nicdark_shadow medium">CHECK IT</a>
                </div>
...
<!-- Mirrored from www.nicdarkthemes.com/themes/baby-kids/html/demo/events.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 11:41:54 GMT -->
</html>