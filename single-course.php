...
<!-- Mirrored from www.nicdarkthemes.com/themes/baby-kids/html/demo/single-course.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 11:42:42 GMT -->
<head>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
		...
		<div class="grid grid_6">
            <p><span class="white nicdark_dropcap nicdark_bg_blue nicdark_radius_circle nicdark_shadow">M</span>oral education is an umbrella term loosely used to describe the teaching of children in a manner that will help them develop variously as moral, civic, good, mannered, behaved, non-bullying, healthy, critical, successful, traditional, compliant or socially acceptable beings. A common approach of these programs is to provide a list of principles, pillars, values or virtues, which are memorized or around which themed activities are planned. It is commonly claimed that the values included in any particular list are universally recognized.<br><br> However, there is no agreement among the competing programs on core values (e.g., honesty, stewardship, kindness, generosity, courage, freedom, justice, equality and respect) or even how many to list. There is also no common or standard means for assessing, implementing or evaluating programs. Character as it relates to character education most often refers to how 'good' a person is. <br><br>In other words, a person who exhibits personal qualities like those a society considers desirable might be considered to have good character—and developing such personal qualities is often seen as a purpose of education. However, the various proponents of character education are far from agreement as to what "good" is, or what qualities are desirable. Compounding this problem is that there is no scientific definition of character. Because such a concept blends personality and behavioral components, scientists have long since abandoned use of the term "character" and instead use the term psychological motivators to measure the behavioral predispositions of individuals. With no clinically defined meaning, there is virtually no way to measure if an individual has a deficit of character, or if a school program can improve it.</p>
        </div>
                ...
                <table class="nicdark_table extrabig nicdark_bg_blue nicdark_radius ">
                    ...
                    <tbody class="nicdark_bg_grey nicdark_border_grey">
                        ...
                        <tr>
                            ...
                            <td><a href="#" class="nicdark_btn_icon nicdark_bg_red small nicdark_radius_circle white"><i class="icon-cancel-outline"></i></a></td>
                        </tr>
                        <tr>
        ...
        <div class="grid grid_4">
            ...
            <ul class="nicdark_list border">
                ...
                <li class="nicdark_border_grey">
                    <p>Lorem ipsum dolor sit amet <a href="#" class="nicdark_btn nicdark_bg_blue extrasmall nicdark_radius nicdark_shadow white right">8:00 AM</a></p> 
                    <div class="nicdark_space15"></div>
                </li>

                <li class="nicdark_border_grey">
                    <div class="nicdark_space15"></div>
                    <p>Lorem ipsum dolor sit amet <a href="#" class="nicdark_btn nicdark_bg_green extrasmall nicdark_radius nicdark_shadow white right">9:00 AM</a></p>   
                    <div class="nicdark_space15"></div>
                </li>
                    
                <li class="nicdark_border_grey">
                    <div class="nicdark_space15"></div>
                    <p>Lorem ipsum dolor sit amet <a href="#" class="nicdark_btn nicdark_bg_yellow extrasmall nicdark_radius nicdark_shadow white right">2:00 PM</a></p>   
                    <div class="nicdark_space15"></div>
                </li>

                <li class="nicdark_border_grey">
                    <div class="nicdark_space15"></div>
                    <p>Lorem ipsum dolor sit amet <a href="#" class="nicdark_btn nicdark_bg_orange extrasmall nicdark_radius nicdark_shadow white right">3:00 PM</a></p>   
                    <div class="nicdark_space15"></div>
                </li>

                <li class="nicdark_border_grey">
                    <div class="nicdark_space15"></div>
                    <p>Lorem ipsum dolor sit amet <a href="#" class="nicdark_btn nicdark_bg_red extrasmall nicdark_radius nicdark_shadow white right">4:00 PM</a></p>    
                </li>
