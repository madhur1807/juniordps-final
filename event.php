...
<head>
    ...
    <title>Event</title> <!--insert your title here-->
    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                ...
                <div class="nicdark_space100"></div>
                <h1 class="white subtitle">Independence Day Celebrations 2018</h1>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_12 nicdark_bg_grey nicdark_shadow nicdark_radius">
            <div class="nicdark_margin103 extra_container">
                <div class="grid grid_4 percentage">
                    <div class="nicdark_margin10 nicdark_relative">
                        <a href="#" class="nicdark_btn_icon nicdark_bg_green nicdark_shadow extrabig nicdark_radius_circle white nicdark_absolute nicdark_displaynone_ipadpotr"><i class="icon-location-outline"></i></a>
                ...
                <div class="grid grid_4 percentage">
                    <div class="nicdark_margin10 nicdark_relative">
                        <a href="#" class="nicdark_btn_icon nicdark_bg_red extrabig nicdark_shadow nicdark_radius_circle white nicdark_absolute nicdark_displaynone_ipadpotr"><i class="icon-wristwatch"></i></a>
                ...
                <div class="grid grid_4 percentage">
                    <div class="nicdark_margin10 nicdark_relative">
                        <a href="#" class="nicdark_btn_icon nicdark_bg_yellow extrabig nicdark_shadow nicdark_radius_circle white nicdark_absolute nicdark_displaynone_ipadpotr"><i class="icon-phone-outline"></i></a>

                        <div class="nicdark_activity nicdark_marginleft100 nicdark_disable_marginleft_ipadpotr">
                            <h4>EVENT INCHARGE</h4>
                            <div class="nicdark_space20"></div>
                            <p>Miss Savita, call for more details (00) 051907080</p>
                        </div>
                    </div>
                </div>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
		...
		<div class="grid grid_6">
            <p><span class="white nicdark_dropcap nicdark_bg_red nicdark_radius nicdark_shadow">L</span>et's celebrate our Independence Day on 13th August with pomp and show.<br>
              Parents and relatives all are welcome.</p>
            <div class="nicdark_space10"></div>
            <div class="nicdark_focus center">
                <div class="nicdark_margin10">
                    <a title="ADD THIS EVENT" href="#" class="nicdark_tooltip nicdark_btn nicdark_bg_red medium nicdark_shadow nicdark_radius white nicdark_margin10"><i class="icon-calendar-1"></i>&nbsp;&nbsp;&nbsp;Add to iCal</a>
                </div>
                <div class="nicdark_margin10">
                    <a title="CONTACT US" href="#" class="nicdark_tooltip nicdark_btn nicdark_bg_green medium nicdark_shadow nicdark_radius white nicdark_margin10"><i class="icon-info-outline"></i>&nbsp;&nbsp;&nbsp;Add to Google Calendar</a>
                </div>
            </div>
        </div>
...
<div class="nicdark_tab">
    ...
    <ul class="nicdark_tabslist">
        <li><a title="Photos" href="#tabs-1" class="nicdark_tooltip nicdark_btn nicdark_bg_yellow medium nicdark_radius_top white"><i class="icon-heart-2 nicdark_marginright10 nicdark_displaynone_ipadpotr nicdark_displaynone_iphonepotr"></i>Photos</a></li>
        <li><a title="Videos" href="#tabs-2" class="nicdark_tooltip nicdark_btn nicdark_bg_orange medium nicdark_radius_top white"><i class="icon-heart-2 nicdark_marginright10 nicdark_displaynone_ipadpotr nicdark_displaynone_iphonepotr"></i>Videos</a></li>
    </ul>
            ...
            <div id="nicdark_slide2" class="tp-banner">
              ...
              <ul>
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on"  data-title="LESSON">
                  <img src="img/slide/img6.jpg"  alt="" data-lazylaoad="img/slide/img6.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                </li>
                <!--end second-->
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on"  data-title="FRIENDS">
                  <img src="img/slide/img7.jpg"  alt="" data-lazylaoad="img/slide/img7.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                </li>
                <!--end first-->
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_12 nicdark_bg_grey nicdark_shadow nicdark_radius nicdark_relative">
            ...
            <a href="#" class="nicdark_displaynone_iphoneland nicdark_displaynone_iphonepotr nicdark_btn_icon nicdark_bg_red  extrabig nicdark_radius_left white nicdark_absolute"><i class="icon-heart-2"></i></a>
