...
<!-- Mirrored from www.nicdarkthemes.com/themes/baby-kids/html/demo/teachers.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 11:42:02 GMT -->
<head>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_12">
            <h1 class="subtitle greydark">ENGLISH</h1>
            <div class="nicdark_space20"></div>
            ...
            <div class="nicdark_archive1 nicdark_bg_orange nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <h4 class="white"><a class="white" href="teacher.php">JULIETTE LIGHT</a></h4>                        
                        <div class="nicdark_space20"></div>
                        ...
                        <div class="nicdark_space20"></div>
                        <a href="teacher.php" class="white nicdark_btn"><i class="icon-graduation-cap-1"></i> View More :)</a>
                ...
                <div class="nicdark_textevidence nicdark_width_percentage10 nicdark_displaynone_responsive">
                    ...
                    <a title="Mail" href="teacher.php" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_orangedark nicdark_radius_circle white"><i class="icon-mail"></i></a>
                    <div class="nicdark_space20"></div>
                    <a title="+91-9873088465" href="teacher.php" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_orangedark nicdark_radius_circle white"><i class="icon-phone-outline"></i></a>
                    <div class="nicdark_space20"></div>
                    <a title="Social Media Profiles" href="teacher.php" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_orangedark nicdark_radius_circle white"><i class=" icon-export"></i></a>
                    <div class="nicdark_space20"></div>
                </div>
            ...
            <div class="nicdark_archive1 nicdark_bg_blue nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <h4 class="white"><a class="white" href="teacher.php">JENNY MGRAYAN</a></h4>                        
                        <div class="nicdark_space20"></div>
                        <div class="nicdark_divider left small"><span class="nicdark_bg_white nicdark_radius"></span></div>
                        <div class="nicdark_space20"></div>
                        <p class="white">Lorem ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet.</p>
                ...
                <div class="nicdark_textevidence nicdark_width_percentage10 nicdark_displaynone_responsive">
                    <div class="nicdark_space20"></div>
                    <div class="nicdark_space5"></div>
                    <a title="Mail" href="teacher.php" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_bluedark nicdark_radius_circle white"><i class="icon-mail"></i></a>
                    <div class="nicdark_space20"></div>
                    <a title="+91-9873088465" href="teacher.php" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_bluedark nicdark_radius_circle white"><i class="icon-phone-outline"></i></a>
                    <div class="nicdark_space20"></div>
                    <a title="Social Media Profiles" href="teacher.php" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_bluedark nicdark_radius_circle white"><i class=" icon-export"></i></a>
                    <div class="nicdark_space20"></div>
                </div>
            ...
            <div class="nicdark_archive1 nicdark_bg_yellow nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <h4 class="white"><a class="white" href="teacher.php">MARGARET GREY</a></h4>                        
                        <div class="nicdark_space20"></div>
                        <div class="nicdark_divider left small"><span class="nicdark_bg_white nicdark_radius"></span></div>
                        <div class="nicdark_space20"></div>
                        <p class="white">Lorem ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet.</p>
                ...
                <div class="nicdark_textevidence nicdark_width_percentage10 nicdark_displaynone_responsive">
                    <div class="nicdark_space20"></div>
                    <div class="nicdark_space5"></div>
                    <a title="Mail" href="teacher.php" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_yellowdark nicdark_radius_circle white"><i class="icon-mail"></i></a>
                    <div class="nicdark_space20"></div>
                    <a title="+91-9873088465" href="teacher.php" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_yellowdark nicdark_radius_circle white"><i class="icon-phone-outline"></i></a>
                    <div class="nicdark_space20"></div>
                    <a title="Social Media Profiles" href="teacher.php" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_yellowdark nicdark_radius_circle white"><i class=" icon-export"></i></a>
                    <div class="nicdark_space20"></div>
                </div>
            ...
            <div class="nicdark_archive1 nicdark_bg_violet nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <h4 class="white"><a class="white" href="teacher.php">NICK HOPE</a></h4>                        
                        <div class="nicdark_space20"></div>
                        <div class="nicdark_divider left small"><span class="nicdark_bg_white nicdark_radius"></span></div>
                        <div class="nicdark_space20"></div>
                        <p class="white">Lorem ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet.</p>
                ...
                <div class="nicdark_textevidence nicdark_width_percentage10 nicdark_displaynone_responsive">
                    <div class="nicdark_space20"></div>
                    <div class="nicdark_space5"></div>
                    <a title="Mail" href="teacher.php" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_violetdark nicdark_radius_circle white"><i class="icon-mail"></i></a>
                    <div class="nicdark_space20"></div>
                    <a title="+91-9873088465" href="teacher.php" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_violetdark nicdark_radius_circle white"><i class="icon-phone-outline"></i></a>
                    <div class="nicdark_space20"></div>
                    <a title="Social Media Profiles" href="teacher.php" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_violetdark nicdark_radius_circle white"><i class=" icon-export"></i></a>
                    <div class="nicdark_space20"></div>
                </div>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_12">
            <h1 class="subtitle greydark">HINDI</h1>
            <div class="nicdark_space20"></div>
            <h3 class="subtitle grey">FULL TIME · AGE: 3-6 YEARS OLD</h3>
            <div class="nicdark_space20"></div>
            <div class="nicdark_divider left big"><span class="nicdark_bg_orange nicdark_radius"></span></div>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_12">
            <h1 class="subtitle greydark">MATHEMATICS</h1>
            <div class="nicdark_space20"></div>
            <h3 class="subtitle grey">FULL TIME · AGE: 3-6 YEARS OLD</h3>
            <div class="nicdark_space20"></div>
            <div class="nicdark_divider left big"><span class="nicdark_bg_orange nicdark_radius"></span></div>
...
<!-- Mirrored from www.nicdarkthemes.com/themes/baby-kids/html/demo/teachers.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 11:42:09 GMT -->
</html>